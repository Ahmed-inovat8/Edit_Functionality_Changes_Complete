...
*** Test Cases ***
US21 Testing MEA Edit Functionality, Editing Testing Details and MEA Configurations 
    Login to Sora Fuel
    ...
    Set Fabricated by to "Ammad" from MEA Details on Initiation Page
    Select the following Value "Std Ni Foam" for the "Catalyst Layer Anode ID" from Experiment Initiation page
    Select the following Value "2-2-100" for the "Catalyst Layer Cathode ID" from Experiment Initiation page
    Add Test Details "Test Station" from Testing Details Page with Value "TS2 V2"
    Add Test Details "Tested By" from Testing Details Page with Value "Ammad"
