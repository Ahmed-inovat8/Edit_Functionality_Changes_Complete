...
US16 Testing Client Feedback Functionalities
    ...
    Verify that Date is already selected as the Current Date "3"
    ...
    Verify Date of Fabrication to be the same as Current Date "3"
    ...
    Navigate to the MEA Page for "P5544"
